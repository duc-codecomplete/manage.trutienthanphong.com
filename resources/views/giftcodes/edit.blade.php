                    ...
                    <form action="" method="POST" class="form-horizontal form-label-left">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                <input type="text" value="{{$giftcode->giftcode}}" name="giftcode" class="form-control">
                            </div>
                        </div>
                        <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align">ID Vật Phẩm</label>
                            <div class="col-md-6 col-sm-6 ">
                                <input type="number" value="{{$giftcode->itemid}}" name="itemid" class="form-control">
                            </div>
                        </div>
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                <input name="expired" class="form-control" placeholder="dd-mm-yyyy"
                                    type="date" required="required" value="{{\Carbon\Carbon::parse($giftcode->expired)->format("Y-m-d")}}">
                            </div>
                        </div>
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                <select name="is_vip" id="" class="form-control">
                                    <option value="0" @php if(!$giftcode->is_vip) { echo "selected";} @endphp>Tất cả thành viên</option>
                                    <option value="1" @php if($giftcode->is_vip) { echo "selected";} @endphp>Chỉ dành cho vip</option>
                                </select>
                            </div>
                        </div>
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                <input value="{{$giftcode->vip_level}}" type="number" class="form-control" name="vip_level" min="1" max="8">
                            </div>
                        </div>
